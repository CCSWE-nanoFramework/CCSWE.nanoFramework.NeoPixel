...
namespace CCSWE.nanoFramework.NeoPixel.Brightness.Float
{
    ...
    {
        public HslColor(float hue, float saturation, float light, int alpha)
        {
            PreciseHue = hue;
        ...
        /// </summary>
        public float PreciseSaturation { get; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return Math.Abs(Hue - color.PreciseHue) < float.Epsilon &&
                   Math.Abs(Saturation - color.PreciseSaturation) < float.Epsilon &&
                   Math.Abs(Light - color.PreciseLight) < float.Epsilon;
        }
